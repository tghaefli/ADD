...
* @file xosd.h
*
* This is the Xilinx MVI On-Screen-Display (OSD) device driver.
*
...
/**
 * This typedef contains configuration information for an OSD device.
...
typedef struct {
    ...
    u16 Layer0FontAsciiOffset;	      /**< Font: ASCII offset of 1st character
                                        */
    u16 Layer0TextNumStrings;		  /**< Text: Number of Strings */
    u16 Layer0TextMaxStringLength;    /**< Text: Maximum length of a String */
    ...
    u16 Layer1FontAsciiOffset;	      /**< Font: ASCII offset of 1st character
                                        */
    u16 Layer1TextNumStrings;		  /**< Text: Number of Strings */
    u16 Layer1TextMaxStringLength;    /**< Text: Maximum length of a String */
    ...
    u16 Layer2FontBitsPerPixel;		  /**< Font: Number of bits per pixel */
    u16 Layer2FontAsciiOffset;	      /**< Font: ASCII offset of 1st character
                                        */
    u16 Layer2TextNumStrings;		  /**< Text: Number of Strings */
    u16 Layer2TextMaxStringLength;    /**< Text: Maximum length of a String */
    ...
    u16 Layer3FontAsciiOffset;	      /**< Font: ASCII offset of 1st character
                                        */
    u16 Layer3TextNumStrings;		  /**< Text: Number of Strings */
    u16 Layer3TextMaxStringLength;    /**< Text: Maximum length of a String */
    ...
    u16 Layer4FontBitsPerPixel;		  /**< Font: Number of bits per pixel */
    u16 Layer4FontAsciiOffset;	      /**< Font: ASCII offset of 1st character
                                        */
    u16 Layer4TextNumStrings;		  /**< Text: Number of Strings */
    u16 Layer4TextMaxStringLength;    /**< Text: Maximum length of a String */
    ...
    u16 Layer5FontBitsPerPixel;		  /**< Font: Number of bits per pixel */
    u16 Layer5FontAsciiOffset;	      /**< Font: ASCII offset of 1st character
                                        */
    u16 Layer5TextNumStrings;		  /**< Text: Number of Strings */
    u16 Layer5TextMaxStringLength;    /**< Text: Maximum length of a String */
    ...
    u16 Layer6FontBitsPerPixel;		  /**< Font: Number of bits per pixel */
    u16 Layer6FontAsciiOffset;	      /**< Font: ASCII offset of 1st character
                                        */
    u16 Layer6TextNumStrings;		  /**< Text: Number of Strings */
    u16 Layer6TextMaxStringLength;    /**< Text: Maximum length of a String */
    ...
    u16 Layer7FontBitsPerPixel;		  /**< Font: Number of bits per pixel */
    u16 Layer7FontAsciiOffset;	      /**< Font: ASCII offset of 1st character
                                        */
    u16 Layer7TextNumStrings;		  /**< Text: Number of Strings */
    u16 Layer7TextMaxStringLength;    /**< Text: Maximum length of a String */
...
typedef struct {
    ...
    u16 FontAsciiOffset;	    /**< Font: ASCII offset of 1st character
                                  */
    u16 TextNumStrings;		    /**< Text: Number of Strings */
    u16 TextMaxStringLength;    /**< Text: Maximum length of a String */
...
typedef struct {
    ...
    XOSD_CallBack VbiStartCallBack;	/**< Call back for Vertical Blank Interval
                                      *  (VBI) Start interrupt */
    void *VbiStartRef;              /**< To be passed to the VBI Start
                                      *  interrupt callback */

    XOSD_CallBack VbiEndCallBack;	/**< Call back for Vertical Blank Interval
                                      *  (VBI) End interrupt */
    void *VbiEndRef;				/**< To be passed to the VBI End interrupt
                                      *  callback */
...
void XOSD_SetBlankPolarity(XOSD *InstancePtr, int VerticalBlankPriority,
                           int HorizontalBlankPriority);
...
void XOSD_GetLayerAlpha(XOSD *InstancePtr, u8 LayerIndex,
                        u8 *GlobalAlphaEnblePtr, u8 *GlobalAlphaValuePtr);
...
int XOSD_IntrCallBackSet(XOSD * InstancePtr, u32 IntrType,
